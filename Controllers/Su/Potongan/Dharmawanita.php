...
use App\Models\Su\Potongan\DharmawanitaModel;
use Config\Services;
...
extends BaseController
{
    ...
    public function getAll()
    {
        ...
        $datamodel = new DharmawanitaModel($request);
    ...
    {
        return redirect()->to(base_url('su/potongan/dharmawanita/data'));
    }

    public function data()
    {
        $data['title'] = 'DATA POTONGAN DHARMAWANITA';
        ...
        return view('su/potongan/dharmawanita/index', $data);
    }
    ...
    public function generate()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $apiLib = new Apilib();
            $result = $apiLib->generatePotonganDharmaWanita($tahun);
            ...
            if ($result) {
                ...
                if ($result->status == 200) {
                    ...
                    $response->message = "Generate Potongan Dharma Wanita Berhasil Dilakukan.";
                    return json_encode($response);
                } else {
                    $response = new \stdClass;
                    $response->status = 400;
                    $response->error = $result;
                    $response->message = "Gagal Generate Potongan Dharma Wanita.";
                    return json_encode($response);
                }
            } else {
                $response = new \stdClass;
