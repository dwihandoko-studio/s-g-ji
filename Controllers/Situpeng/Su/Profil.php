...
namespace App\Controllers\Situpeng\Su;

use App\Controllers\BaseController;
// use App\Models\Situpeng\Ptk\PtkModel;
use Config\Services;
...
class Profil extends BaseController
{
    ...
    {
        return redirect()->to(base_url('situpeng/su/profil/data'));
    }
    ...
    public function data()
    {
        ...
        return view('situpeng/su/profil/index', $data);
        // return view('situpeng/ops/404', $data);
    }
    ...
    public function edit()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            switch ($id) {
                case 'password':
                    $response->data = view('situpeng/su/profil/password', $data);
                    break;
                case 'foto':
                    $response->data = view('situpeng/su/profil/foto', $data);
                    break;
                case 'aktivasi_wa':
                    $response->data = view('situpeng/su/profil/aktivasi_wa', $data);
                    break;
                case 'aktivasi_email':
                    $response->data = view('situpeng/su/profil/aktivasi_email', $data);
                    break;

                default:
                    $response->data = view('situpeng/su/profil/edit', $data);
                    break;
            }
    ...
    public function getAktivasiEmail()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if ($id == "wa") {
                ...
                $response->status = 200;
                $response->message = "Permintaan diizinkan";
                $response->data = view('situpeng/su/profil/wa', $x);
                return json_encode($response);
            } else if ($id == "email") {
                $x['user'] = $user->data;
                $response = new \stdClass;
                $response->status = 200;
                $response->message = "Permintaan diizinkan";
                $response->data = view('situpeng/su/profil/email', $x);
                return json_encode($response);
            } else {
                $response = new \stdClass;
                $response->status = 400;
    ...
    public function kirimAktivasiEmail()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if ($sendEmail->code == 200) {
                ...
                $response->status = 200;
                $response->message = "Permintaan diizinkan";
                $response->data = view('situpeng/su/profil/kode_email', $x);
                return json_encode($response);
            } else {
                $response = new \stdClass;
                $response->status = 400;
    ...
    public function kirimAktivasiWa()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if ($sended) {
                ...
                $response->status = 200;
                $response->message = "Permintaan diizinkan";
                $response->data = view('situpeng/su/profil/kode', $x);
                return json_encode($response);
            } else {
                $response = new \stdClass;
                $response->status = 400;
