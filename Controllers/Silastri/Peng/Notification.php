...
class Notification extends BaseController
{
    ...
    {
        return redirect()->to(base_url('silastri/peng/notification/data'));
    }
    ...
    public function data()
    {
        ...
        $data['notifs'] = $this->_db->table('_notification_tb a')
            ...
            ->get()->getResult();
        return view('silastri/peng/notification/index', $data);
    }
    ...
    public function getNotifShowed()
    {
        ...
        if (count($notifs) > 0) {
            ...
            $response->content = view('silastri/peng/notification/pop', $x);
