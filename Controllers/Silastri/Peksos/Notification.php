...
namespace App\Controllers\Silastri\Peksos;
...
class Notification extends BaseController
{
    ...
    {
        return redirect()->to(base_url('silastri/peksos/notification/data'));
    }
    ...
    public function data()
    {
        ...
        $data['notifs'] = $this->_db->table('_notification_tb a')
            ...
            ->get()->getResult();
        return view('silastri/peksos/notification/index', $data);
    }
    ...
    public function getNotifShowed()
    {
        ...
        if (count($notifs) > 0) {
            ...
            $response->content = view('silastri/peksos/notification/pop', $x);
