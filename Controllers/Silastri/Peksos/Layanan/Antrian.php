...
use App\Models\Silastri\Peksos\Layanan\AntrianModel;
use Config\Services;
...
class Antrian extends BaseController
{
    ...
    {
        return redirect()->to(base_url('silastri/peksos/layanan/antrian/data'));
    }
    ...
    public function data()
    {
        ...
        return view('silastri/peksos/layanan/antrian/index', $data);
    }
    ...
    public function detail()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if ($current) {
                ...
                $response->data = view('silastri/peksos/layanan/antrian/detail', $data);
                return json_encode($response);
            } else {
                $response = new \stdClass;
                $response->status = 400;
            ...
            try {
                ...
                if ($this->_db->affectedRows() > 0) {
                    ...
                    if ($this->_db->affectedRows() > 0) {
                        ...
                        $response = new \stdClass;
                        $response->status = 200;
                        $response->redirrect = base_url('silastri/peksos/layanan/proses/detail') . '?token=' . $id;
    ...
    public function formtolak()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $response->status = 200;
            $response->message = "Permintaan diizinkan";
            $response->data = view('silastri/peksos/layanan/antrian/tolak', $data);
            return json_encode($response);
        }
    }
