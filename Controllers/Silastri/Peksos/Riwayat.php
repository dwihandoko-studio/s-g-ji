...
class Riwayat extends BaseController
{
    ...
    {
        return redirect()->to(base_url('silastri/peksos/riwayat/data'));
    }
    ...
    public function data()
    {
        ...
        //     ->where('a.send_to', $id)
        //     ->get()->getResult();
        return view('silastri/peksos/riwayat/index', $data);
    }
    ...
    public function getNotifShowed()
    {
        ...
        if (count($notifs) > 0) {
            ...
            $response->content = view('situgu/peksos/notification/pop', $x);
