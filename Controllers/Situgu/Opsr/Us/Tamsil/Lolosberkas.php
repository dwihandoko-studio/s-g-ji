...
use App\Models\Situgu\Opsr\Tamsil\LolosberkasModel;
use Config\Services;
...
class Lolosberkas extends BaseController
{
    ...
    {
        return redirect()->to(base_url('situgu/opsr/us/tamsil/lolosberkas/data'));
    }
    ...
    public function data()
    {
        ...
        return view('situgu/opsr/us/tamsil/lolosberkas/index', $data);
    }
