...
namespace App\Controllers\Situgu\Opsr\Us\Tamsil;

use App\Controllers\BaseController;
use App\Models\Situgu\Opsr\Tamsil\ProsestransferModel;
use Config\Services;
...
class Prosestransfer extends BaseController
{
    ...
    {
        return redirect()->to(base_url('situgu/opsr/us/tamsil/prosestransfer/data'));
    }

    public function data()
    {
        $data['title'] = 'USULAN PROSES TRANSFER TUNJANGAN TAMSIL';
        ...
        return view('situgu/opsr/us/tamsil/prosestransfer/index', $data);
    }
    ...
    public function detail()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $current = $this->_db->table('v_prosestransfer_usulan_tamsil a')
            ...
            if ($current) {
                ...
                $response->data = view('situgu/opsr/us/tamsil/detail-lolos', $data);
                return json_encode($response);
            } else {
                $response = new \stdClass;
                $response->status = 400;
