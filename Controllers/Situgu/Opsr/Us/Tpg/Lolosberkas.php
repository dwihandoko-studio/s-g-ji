...
use App\Models\Situgu\Opsr\Tpg\LolosberkasModel;
use Config\Services;
...
class Lolosberkas extends BaseController
{
    ...
    {
        return redirect()->to(base_url('situgu/opsr/us/tpg/lolosberkas/data'));
    }
    ...
    public function data()
    {
        ...
        return view('situgu/opsr/us/tpg/lolosberkas/index', $data);
    }
