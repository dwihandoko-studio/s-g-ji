...
use App\Models\Situgu\Opsr\Tpg\AntrianModel;
use Config\Services;
...
class Antrian extends BaseController
{
    ...
    {
        return redirect()->to(base_url('situgu/opsr/us/tpg/antrian/data'));
    }

    public function data()
    {
        $data['title'] = 'ANTRIAN USULAN TUNJANGAN PROFESI GURU';
        ...
        return view('situgu/opsr/us/tpg/antrian/index', $data);
    }
