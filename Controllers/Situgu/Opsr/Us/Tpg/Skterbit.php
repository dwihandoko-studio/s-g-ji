...
use App\Models\Situgu\Opsr\Tpg\TerbitskModel;
use Config\Services;
...
class Skterbit extends BaseController
{
    ...
    public function getAll()
    {
        ...
        $datamodel = new TerbitskModel($request);
    ...
    {
        return redirect()->to(base_url('situgu/opsr/us/tpg/skterbit/data'));
    }

    public function data()
    {
        $data['title'] = 'USULAN TERBIT SK TUNJANGAN PROFESI GURU';
        ...
        return view('situgu/opsr/us/tpg/skterbit/index', $data);
    }
