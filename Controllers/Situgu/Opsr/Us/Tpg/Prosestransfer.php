...
namespace App\Controllers\Situgu\Opsr\Us\Tpg;

use App\Controllers\BaseController;
use App\Models\Situgu\Opsr\Tpg\ProsestransferModel;
use Config\Services;
...
class Prosestransfer extends BaseController
{
    ...
    {
        return redirect()->to(base_url('situgu/opsr/us/tpg/prosestransfer/data'));
    }

    public function data()
    {
        $data['title'] = 'USULAN PROSES TRANSFER TUNJANGAN PROFESI GURU';
        ...
        return view('situgu/opsr/us/tpg/prosestransfer/index', $data);
    }
    ...
    public function detail()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $current = $this->_db->table('v_prosestransfer_usulan_tpg a')
            ...
            if ($current) {
                ...
                $response->data = view('situgu/opsr/us/tpg/detail-lolos', $data);
                return json_encode($response);
            } else {
                $response = new \stdClass;
                $response->status = 400;
