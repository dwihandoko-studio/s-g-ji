...
use App\Models\Situgu\Opsr\VerifikasiptkModel;
use Config\Services;
...
class Ptk extends BaseController
{
    ...
    {
        return redirect()->to(base_url('situgu/opsr/verifikasi/ptk/data'));
    }
    ...
    public function data()
    {
        ...
        return view('situgu/opsr/verifikasi/ptk/index', $data);
    }
    ...
    public function detail()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if ($current) {
                ...
                $response->data = view('situgu/opsr/verifikasi/ptk/detail', $data);
                return json_encode($response);
            } else {
                $response = new \stdClass;
                $response->status = 400;
    ...
    public function formtolak()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $response->status = 200;
            $response->message = "Permintaan diizinkan";
            $response->data = view('situgu/opsr/verifikasi/ptk/tolak', $data);
            return json_encode($response);
        }
    }
