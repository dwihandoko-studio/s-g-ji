...
use App\Models\Situgu\Opsr\VerifikasipenggunaModel;
use Config\Services;
...
class Pengguna extends BaseController
{
    ...
    {
        return redirect()->to(base_url('situgu/opsr/verifikasi/pengguna/data'));
    }
    ...
    public function data()
    {
        ...
        return view('situgu/opsr/verifikasi/pengguna/index', $data);
    }
    ...
    public function detail()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if ($current) {
                ...
                $response->data = view('situgu/opsr/verifikasi/pengguna/detail', $data);
                return json_encode($response);
            } else {
                $response = new \stdClass;
                $response->status = 400;
    ...
    public function formtolak()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $response->status = 200;
            $response->message = "Permintaan diizinkan";
            $response->data = view('situgu/opsr/verifikasi/pengguna/tolak', $data);
            return json_encode($response);
        }
    }
