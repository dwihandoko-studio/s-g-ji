...
use App\Models\Situgu\Opk\Tamsil\AntrianModel;
use Config\Services;
...
class Antrian extends BaseController
{
    ...
    {
        return redirect()->to(base_url('situgu/opk/us/tamsil/antrian/data'));
    }
    ...
    public function data()
    {
        ...
        return view('situgu/opk/us/tamsil/antrian/index', $data);
    }
