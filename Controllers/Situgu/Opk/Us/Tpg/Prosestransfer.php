...
namespace App\Controllers\Situgu\Opk\Us\Tpg;

use App\Controllers\BaseController;
use App\Models\Situgu\Opk\Tpg\ProsestransferModel;
use Config\Services;
...
class Prosestransfer extends BaseController
{
    ...
    {
        return redirect()->to(base_url('situgu/opk/us/tpg/prosestransfer/data'));
    }
    ...
    public function data()
    {
        ...
        return view('situgu/opk/us/tpg/prosestransfer/index', $data);
    }
    ...
    public function detail()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if ($current) {
                ...
                $response->data = view('situgu/opk/us/tpg/detail-lolos', $data);
                return json_encode($response);
            } else {
                $response = new \stdClass;
                $response->status = 400;
