...
use App\Models\Situgu\Opk\Tpg\TerbitskModel;
use Config\Services;
...
class Skterbit extends BaseController
{
    ...
    {
        return redirect()->to(base_url('situgu/opk/us/tpg/skterbit/data'));
    }
    ...
    public function data()
    {
        ...
        return view('situgu/opk/us/tpg/skterbit/index', $data);
    }
