...
use App\Models\Situgu\Opk\Tpg\LolosberkasModel;
use Config\Services;
...
class Lolosberkas extends BaseController
{
    ...
    {
        return redirect()->to(base_url('situgu/opk/us/tpg/lolosberkas/data'));
    }
    ...
    public function data()
    {
        ...
        return view('situgu/opk/us/tpg/lolosberkas/index', $data);
    }
