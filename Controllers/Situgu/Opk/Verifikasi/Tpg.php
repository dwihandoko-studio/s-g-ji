...
use App\Models\Situgu\Opk\VerifikasitpgdetailModel;
use App\Models\Situgu\Opk\VerifikasitpgsekolahModel;
use Config\Services;
...
class Tpg extends BaseController
{
    ...
    {
        return redirect()->to(base_url('situgu/opk/verifikasi/tpg/data'));
    }
    ...
    public function data()
    {
        ...
        return view('situgu/opk/verifikasi/tpg/index', $data);
    }
    ...
    public function datalist()
    {
        ...
        $data['kode_usulan'] = $id;
        $data['tw'] = $this->_db->table('_ref_tahun_tw')->where('is_current', 1)->orderBy('tahun', 'desc')->orderBy('tw', 'desc')->get()->getRowObject();
        return view('situgu/opk/verifikasi/tpg/detail_index', $data);
    }
    ...
    public function formtolak()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $response->status = 200;
            $response->message = "Permintaan diizinkan";
            $response->data = view('situgu/opk/verifikasi/tpg/tolak', $data);
            return json_encode($response);
        }
    }
