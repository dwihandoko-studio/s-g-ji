...
namespace App\Controllers\Situgu\Opk\Sptjm;

use App\Controllers\BaseController;
use App\Models\Situgu\Opk\SptjmModel;
use Config\Services;
...
class Tamsil extends BaseController
{
    ...
    {
        return redirect()->to(base_url('situgu/opk/sptjm/tamsil/data'));
    }
    ...
    public function data()
    {
        ...
        return view('situgu/opk/sptjm/tamsil/index', $data);
    }
    ...
    public function add()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if ($current) {
                ...
                $response->data = view('situgu/opk/sptjm/tamsil/add', $data);
                return json_encode($response);
            } else {
                $response = new \stdClass;
                $response->status = 400;
    ...
    public function detail()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $response->status = 200;
            $response->message = "Permintaan diizinkan";
            $response->data = view('situgu/opk/sptjm/tamsil/detail', $data);
            return json_encode($response);
        }
    }
    ...
    public function formuploadedit()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $response->status = 200;
            $response->message = "Permintaan diizinkan";
            $response->data = view('situgu/opk/sptjm/tamsil/upload_edit', $data);
            return json_encode($response);
        }
    }
    ...
    public function formupload()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $response->status = 200;
            $response->message = "Permintaan diizinkan";
            $response->data = view('situgu/opk/sptjm/tamsil/upload', $data);
            return json_encode($response);
        }
    }
