...
use App\Models\Situgu\Ops\Tpg\LolosberkasModel;
use Config\Services;
...
class Lolosberkas extends BaseController
{
    ...
    {
        return redirect()->to(base_url('situgu/ops/us/tpg/lolosberkas/data'));
    }
    ...
    public function data()
    {
        ...
        return view('situgu/ops/us/tpg/lolosberkas/index', $data);
    }
