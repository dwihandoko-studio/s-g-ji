...
use App\Models\Situgu\Ops\Tpg\TerbitskModel;
use Config\Services;
...
class Skterbit extends BaseController
{
    ...
    {
        return redirect()->to(base_url('situgu/ops/us/tpg/skterbit/data'));
    }
    ...
    public function data()
    {
        ...
        return view('situgu/ops/us/tpg/skterbit/index', $data);
    }
