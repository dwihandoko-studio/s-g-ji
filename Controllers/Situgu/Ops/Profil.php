...
class Profil extends BaseController
{
    ...
    {
        return redirect()->to(base_url('situgu/ops/profil/data'));
    }
    ...
    public function edit()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            switch ($id) {
                case 'password':
                    $response->data = view('situgu/ops/profil/password', $data);
                    break;
                case 'foto':
                ...
                case 'aktivasi_wa':
                    ...
                    break;
                case 'aktivasi_email':
                    $response->data = view('situgu/ops/profil/aktivasi_email', $data);
                    break;
    ...
    public function kirimAktivasiEmail()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if ($sendEmail->code == 200) {
                ...
                $response->status = 200;
                $response->message = "Permintaan diizinkan";
                $response->data = view('situgu/ops/profil/kode_email', $x);
                return json_encode($response);
            } else {
                $response = new \stdClass;
                $response->status = 400;
