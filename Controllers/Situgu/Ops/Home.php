...
class Home extends BaseController
{
    ...
    public function index()
    {
        ...
        $data['informasis'] = $this->_db->table('_tb_infopop')->select("*, (SELECT count(*) FROM _tb_infopop WHERE tampil = 1 AND (tujuan_role LIKE '%OPS%' OR tujuan_role LIKE '%ALL%')) as jumlah_all")->where("tampil = 1 AND (tujuan_role LIKE '%OPS%' OR tujuan_role LIKE '%ALL%')")->orderBy('created_at', 'DESC')->limit(5)->get()->getResult();
