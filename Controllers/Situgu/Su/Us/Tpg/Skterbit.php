...
use App\Models\Situgu\Su\Tpg\TerbitskModel;
use Config\Services;
...
class Skterbit extends BaseController
{
    ...
    {
        return redirect()->to(base_url('situgu/su/us/tpg/skterbit/data'));
    }
    ...
    public function data()
    {
        ...
        return view('situgu/su/us/tpg/skterbit/index', $data);
    }
