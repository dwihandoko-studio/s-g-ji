...
use App\Models\Situgu\Su\Tpg\ProsestransferModel;
use Config\Services;
...
class Prosestransfer extends BaseController
{
    ...
    {
        return redirect()->to(base_url('situgu/su/us/tpg/prosestransfer/data'));
    }
    ...
    public function data()
    {
        ...
        return view('situgu/su/us/tpg/prosestransfer/index', $data);
    }
