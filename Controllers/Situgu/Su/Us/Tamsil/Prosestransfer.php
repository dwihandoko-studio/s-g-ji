...
use App\Models\Situgu\Su\Tamsil\ProsestransferModel;
use Config\Services;
...
class Prosestransfer extends BaseController
{
    ...
    {
        return redirect()->to(base_url('situgu/su/us/tamsil/prosestransfer/data'));
    }
    ...
    public function data()
    {
        ...
        return view('situgu/su/us/tamsil/prosestransfer/index', $data);
    }
    ...
    public function detail()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if ($current) {
                ...
                $response->data = view('situgu/su/us/tamsil/detail-lolos', $data);
                return json_encode($response);
            } else {
                $response = new \stdClass;
                $response->status = 400;
