...
use App\Models\Situgu\Su\Tamsil\LolosberkasModel;
use Config\Services;
...
class Lolosberkaskembali extends BaseController
{
    ...
    {
        return redirect()->to(base_url('situgu/su/us/tamsil/lolosberkaskembali/data'));
    }
    ...
    public function data()
    {
        ...
        return view('situgu/su/us/tamsil/lolosberkaskembali/index', $data);
    }
            ...
            if ($current) {
                ...
                try {
                    ...
                    if ($this->_db->affectedRows() > 0) {
                        $this->_db->table('_tb_usulan_detail_tamsil')->where('id', $current->id_usulan)->update(['status_usulan' => 0, 'admin_approve' => NULL, 'date_approve' => NULL, 'keterangan_reject' => NULL]);
                        if ($this->_db->affectedRows() > 0) {
