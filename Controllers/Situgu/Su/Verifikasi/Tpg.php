...
use App\Models\Situgu\Su\VerifikasitpgdetailModel;
use App\Models\Situgu\Su\VerifikasitpgsekolahModel;
use Config\Services;
...
class Tpg extends BaseController
{
    ...
    {
        return redirect()->to(base_url('situgu/su/verifikasi/tpg/data'));
    }
    ...
    public function data()
    {
        ...
        return view('situgu/su/verifikasi/tpg/index', $data);
    }
    ...
    public function datalist()
    {
        ...
        $data['kode_usulan'] = $id;
        $data['tw'] = $this->_db->table('_ref_tahun_tw')->where('is_current', 1)->orderBy('tahun', 'desc')->orderBy('tw', 'desc')->get()->getRowObject();
        return view('situgu/su/verifikasi/tpg/detail_index', $data);
    }
    ...
    public function detail()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if ($current) {
                ...
                $response->data = view('situgu/su/verifikasi/tpg/detail', $data);
                return json_encode($response);
            } else {
                $response = new \stdClass;
                $response->status = 400;
    ...
    public function formtolak()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $response->status = 200;
            $response->message = "Permintaan diizinkan";
            $response->data = view('situgu/su/verifikasi/tpg/tolak', $data);
            return json_encode($response);
        }
    }
