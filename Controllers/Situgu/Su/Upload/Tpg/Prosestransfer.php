...
class Prosestransfer extends BaseController
{
    ...
    {
        return redirect()->to(base_url('situgu/su/upload/tpg/prosestransfer/data'));
    }
    ...
    public function data()
    {
        ...
        return view('situgu/su/upload/tpg/prosestransfer/index', $data);
    }
    ...
    public function upload()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $response->data = view('situgu/su/upload/tpg/prosestransfer/upload', $data);
            return json_encode($response);
        }
    }
    ...
    public function uploadSave()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if ($this->_db->affectedRows() > 0) {
                ...
                $response->data = view('situgu/su/upload/tpg/prosestransfer/verifi-upload', $x);
