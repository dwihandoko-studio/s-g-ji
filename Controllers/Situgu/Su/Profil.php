...
class Profil extends BaseController
{
    ...
    public function index()
    {
        ...
        var_dump(rpTanpaAwalan((($us_gaji_pokok * 3) * $pph21)) - ($us_gaji_pokok * 3));
        die;
    ...
    public function data()
    {
        ...
        return view('situgu/su/profil/index', $data);
    ...
    public function edit()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            switch ($id) {
                case 'password':
                    $response->data = view('situgu/su/profil/password', $data);
                    break;
                case 'foto':
                    $response->data = view('situgu/su/profil/foto', $data);
                    break;
                case 'aktivasi_wa':
                    $response->data = view('situgu/su/profil/aktivasi_wa', $data);
                    break;
                case 'aktivasi_email':
                    $response->data = view('situgu/su/profil/aktivasi_email', $data);
                    break;

                default:
                    $response->data = view('situgu/su/profil/edit', $data);
                    break;
            }
