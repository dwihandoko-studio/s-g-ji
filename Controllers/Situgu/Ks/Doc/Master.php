...
class Master extends BaseController
{
    ...
    {
        return redirect()->to(base_url('situgu/ks/doc/master/data'));
    }
    ...
    public function data()
    {
        ...
        return view('situgu/ks/doc/master/index', $data);
    }
    ...
    public function formupload()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $response->data = view('situgu/ks/doc/master/upload', $data);
            return json_encode($response);
        }
    }
    ...
    public function editformupload()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $response->status = 200;
            $response->message = "Permintaan diizinkan";
            $response->data = view('situgu/ks/doc/master/editupload', $data);
            return json_encode($response);
        }
    }
