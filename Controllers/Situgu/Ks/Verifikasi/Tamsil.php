...
namespace App\Controllers\Situgu\Ks\Verifikasi;

use App\Controllers\BaseController;
use App\Models\Situgu\Ks\VerifikasiModel;
use Config\Services;
...
class Tamsil extends BaseController
{
    ...
    {
        return redirect()->to(base_url('situgu/ks/verifikasi/tamsil/data'));
    }
    ...
    public function data()
    {
        ...
        return view('situgu/ks/verifikasi/tamsil/index', $data);
    }
    ...
    public function detail()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if ($current) {
                ...
                $response->data = view('situgu/ks/verifikasi/tamsil/detail', $data);
                return json_encode($response);
            } else {
                $response = new \stdClass;
                $response->status = 400;
    ...
    public function formtolak()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $response->status = 200;
            $response->message = "Permintaan diizinkan";
            $response->data = view('situgu/ks/verifikasi/tamsil/tolak', $data);
            return json_encode($response);
        }
    }
