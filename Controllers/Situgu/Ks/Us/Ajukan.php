...
namespace App\Controllers\Situgu\Ks\Us;
...
class Ajukan extends BaseController
{
    ...
    {
        return redirect()->to(base_url('situgu/ks/us/ajukan/data'));
    }
    ...
    public function data()
    {
        ...
        return view('situgu/ks/us/ajukan/index', $data);
    }
    ...
    public function aksiajukan()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $response->data = view('situgu/ks/us/ajukan/pilihan', $data);
            return json_encode($response);
        }
    }
    ...
    public function getValidationAjuan()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if ($ptk->no_rekening === null || $ptk->no_rekening === "" || $ptk->cabang_bank === null || $ptk->cabang_bank === "") {
                ...
                $response->redirrect = base_url("situgu/ks/masterdata/dapodik");
                return json_encode($response);
            }
            ...
            if ($ptk->lampiran_ktp === null || $ptk->lampiran_ktp === "") {
                ...
                $response->redirrect = base_url("situgu/ks/doc/master");
                return json_encode($response);
            }
