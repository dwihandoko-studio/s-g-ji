...
class Profil extends BaseController
{
    ...
    {
        return redirect()->to(base_url('situgu/adm/profil/data'));
    }
    ...
    public function data()
    {
        ...
        return view('situgu/adm/profil/index', $data);
    ...
    public function edit()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            switch ($id) {
                case 'password':
                    $response->data = view('situgu/adm/profil/password', $data);
                    break;
                case 'foto':
                    $response->data = view('situgu/adm/profil/foto', $data);
                    break;
                case 'aktivasi_wa':
                    $response->data = view('situgu/adm/profil/aktivasi_wa', $data);
                    break;
                case 'aktivasi_email':
                    $response->data = view('situgu/adm/profil/aktivasi_email', $data);
                    break;

                default:
                    $response->data = view('situgu/adm/profil/edit', $data);
                    break;
            }
    ...
    public function getAktivasiEmail()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if ($id == "wa") {
                ...
                $response->status = 200;
                $response->message = "Permintaan diizinkan";
                $response->data = view('situgu/adm/profil/wa', $x);
                return json_encode($response);
            } else if ($id == "email") {
                $x['user'] = $user->data;
                $response = new \stdClass;
                $response->status = 200;
                $response->message = "Permintaan diizinkan";
                $response->data = view('situgu/adm/profil/email', $x);
                return json_encode($response);
            } else {
                $response = new \stdClass;
                $response->status = 400;
    ...
    public function kirimAktivasiEmail()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if ($sendEmail->code == 200) {
                ...
                $response->status = 200;
                $response->message = "Permintaan diizinkan";
                $response->data = view('situgu/adm/profil/kode_email', $x);
                return json_encode($response);
            } else {
                $response = new \stdClass;
                $response->status = 400;
    ...
    public function kirimAktivasiWa()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if ($sended) {
                ...
                $response->status = 200;
                $response->message = "Permintaan diizinkan";
                $response->data = view('situgu/adm/profil/kode', $x);
                return json_encode($response);
            } else {
                $response = new \stdClass;
                $response->status = 400;
