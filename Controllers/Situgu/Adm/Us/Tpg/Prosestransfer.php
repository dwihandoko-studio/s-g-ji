...
namespace App\Controllers\Situgu\Adm\Us\Tpg;

use App\Controllers\BaseController;
use App\Models\Situgu\Adm\Tpg\ProsestransferModel;
use Config\Services;
...
class Prosestransfer extends BaseController
{
    ...
    {
        return redirect()->to(base_url('situgu/adm/us/tpg/prosestransfer/data'));
    }
    ...
    public function data()
    {
        ...
        return view('situgu/adm/us/tpg/prosestransfer/index', $data);
    }
