...
use App\Models\Situgu\Adm\Tamsil\ProsestransferModel;
use Config\Services;
...
class Prosestransfer extends BaseController
{
    ...
    {
        return redirect()->to(base_url('situgu/adm/us/tamsil/prosestransfer/data'));
    }
    ...
    public function data()
    {
        ...
        return view('situgu/adm/us/tamsil/prosestransfer/index', $data);
    }
