...
use App\Models\Situgu\Adm\Tamsil\AntrianModel;
use Config\Services;
...
class Antrian extends BaseController
{
    ...
    {
        return redirect()->to(base_url('situgu/adm/us/tamsil/antrian/data'));
    }
    ...
    public function data()
    {
        ...
        return view('situgu/adm/us/tamsil/antrian/index', $data);
    }
