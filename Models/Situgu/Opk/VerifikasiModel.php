...
{
    protected $table = "_tb_temp_usulan_detail a";
    ...
    function get_datatables($kecamatan, $jenis)
    {
        ...
        $this->dt->where("b.npsn IN (select npsn from ref_sekolah where kode_kecamatan = '$kecamatan' AND bentuk_pendidikan_id = 5)");
