...
namespace App\Models\Situgu\Adm\Tpg;
...
class DitolakModel extends Model
{
    ...
    protected $column_order = array(null, null, 'b.nama', 'b.nik', 'b.nuptk', 'b.jenis_ptk', 'a.date_reject');
    protected $column_search = array('b.nik', 'b.nuptk', 'b.nama');
    protected $order = array('a.date_reject' => 'asc');
    protected $request;
    protected $db;
    protected $dt;
    ...
    function get_datatables()
    {
        ...
        $this->dt->whereIn('a.status_usulan', [3, 4]);
