...
namespace App\Models\Situgu\Opsr\Tamsil;
...
{
    protected $table = "v_ditolak_usulan_tamsil";
    protected $column_order = array(null, null, 'kode_usulan', 'nama', 'nik', 'nuptk', 'jenis_ptk', 'keterangan_reject');
