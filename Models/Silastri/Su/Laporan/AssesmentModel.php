...
namespace App\Models\Silastri\Su\Laporan;
...
class AssesmentModel extends Model
{
    ...
    protected $column_order = array(null, null, 'a.nik_orang_assesment', 'a.nama_orang_assesment', 'a.kk_orang_assesment');
    protected $column_search = array('a.nik_orang_assesment', 'a.nama_orang_assesment');
