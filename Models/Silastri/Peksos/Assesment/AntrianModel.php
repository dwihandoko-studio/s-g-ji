...
class AntrianModel extends Model
{
    ...
    protected $column_order = array(null, null, 'a.jenis', 'c.kode_aduan', 'c.tgl_spt', 'c.lokasi_spt');
    protected $column_search = array('a.jenis');
    ...
    function get_datatables($userId)
    {
        ...
        $this->dt->select("a.id, a.jenis, a.created_at, a.status, c.kode_aduan, c.peserta_spt, c.tgl_spt, c.lokasi_spt");
