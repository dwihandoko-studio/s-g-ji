...
namespace App\Models\Silastri\Peksos\Pengaduan;

use CodeIgniter\HTTP\RequestInterface;
use CodeIgniter\Model;

class AsesmenppksModel extends Model
{
    protected $table = "_pengaduan a";
    protected $column_order = array(null, null, 'a.kategori', 'a.kode_aduan', 'a.nik_aduan', 'a.nama_aduan');
    ...
    function get_datatables($userId)
    {
        ...
        $this->dt->select("a.id, a.kategori, a.kode_aduan, a.user_id, a.nik, a.nik_aduan, a.nama, a.nohp, a.kelurahan, a.nama_aduan, b.fullname, c.peserta_spt, c.tgl_spt, c.lokasi_spt");
        $this->dt->join('_profil_users_tb b', 'b.id = a.user_id');
        $this->dt->join('_pengaduan_tanggapan_spt c', 'c.id = a.id');
        $this->dt->where("a.status_aduan = 2 AND (JSON_CONTAINS(c.peserta_spt, '\"$userId\"', '$'))");
