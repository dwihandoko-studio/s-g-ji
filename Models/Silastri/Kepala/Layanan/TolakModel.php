...
{
    protected $table = "_permohonan_tolak a";
    ...
    {
        $this->dt->select("a.id as id_permohonan, a.layanan, a.kode_permohonan, a.user_id, a.nik, a.nama, a.jenis, a.kelurahan, a.keterangan_reject, a.date_reject, b.kk");
