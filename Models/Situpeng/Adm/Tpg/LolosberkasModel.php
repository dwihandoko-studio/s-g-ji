...
class LolosberkasModel extends Model
{
    ...
    protected $column_order = array(null, null, 'a.kode_usulan', 'b.nama', 'b.nik', 'b.nuptk', 'b.jenis_pengawas', 'a.admin_approve');
    ...
    {
        $this->dt->select("a.id as id_usulan, a.date_approve, a.kode_usulan, a.id_pengawas, a.id_tahun_tw, a.status_usulan, a.date_approve_sptjm, b.nama, b.nik, b.nuptk, b.jenis_pengawas, b.jenjang_pengawas");
