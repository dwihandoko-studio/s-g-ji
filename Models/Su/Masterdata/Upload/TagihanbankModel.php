...
namespace App\Models\Su\Masterdata\Upload;
...
{
    protected $table = "tb_up_masterdata_tagihan_bank a";
    ...
    {
        $this->dt->select("a.*, b.tahun, b.bulan");
        $this->dt->join('_ref_tahun_bulan b', 'a.id_tahun_tw = b.id');
