...
class KorpriModel extends Model
{
    protected $table = "tb_potongan_ a";
    protected $column_order = array(null, null, null, 'b.nama', 'b.nip', 'b.golongan', 'a.korpri');
    ...
    {
        $this->dt->select("a.id, a.id_pegawai, a.korpri, a.tahun, b.nama, b.nip, b.golongan, b.no_rekening_bank, b.kode_instansi, b.nama_instansi, b.nama_kecamatan, c.tahun, c.bulan");
    ...
    {
        $this->dt->select("a.korpri, a.tahun, b.nama, b.nip, b.golongan, b.kode_instansi, b.nama_instansi, b.nama_kecamatan, c.tahun, c.bulan");
        $this->dt->join('_ref_tahun_bulan c', 'a.tahun = c.id');
        $this->dt->join('tb_pegawai_ b', 'a.id_pegawai = b.id');
        if ($this->request->getPost('tw')) {
            if ($this->request->getPost('tw') !== "") {
