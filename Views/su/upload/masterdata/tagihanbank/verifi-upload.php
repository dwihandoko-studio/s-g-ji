                    ...
                    <div class="col-lg-10 align-self-center">
                        <div class="text-lg-center mt-4 mt-lg-0">
                            <div class="row">
                                <div class="col-3">
                                    <div>
                                        <p class="text-muted text-truncate mb-2">Jumlah Data Import</p>
        ...
        fetch("./get_data_json?id=<?= $id ?>")
            ...
            .then(data => {
                ...
                for (let i = 0; i < data.data.length; i++) {
                    ...
                    const jumlahtagihanCell = document.createElement("td");
                    const angsurankeCell = document.createElement("td");
                    numberCell.textContent = 1 + i;
                    namaCell.textContent = data.data[i].nama;
                    nipCell.textContent = data.data[i].nip;
                    jumlahtagihanCell.textContent = data.data[i].jumlah_tagihan;
                    angsurankeCell.textContent = data.data[i].angsuran_ke;
                    row.appendChild(numberCell);
                    row.appendChild(namaCell);
                    row.appendChild(nipCell);
                    row.appendChild(jumlahtagihanCell);
                    row.appendChild(angsurankeCell);
        ...
        function aksiMatching() {
            ...
            let sendToServer = function(lines, index) {
                if (index > lines.length - 1) {
                    ...
                    ambilId("status").innerHTML = "Proses Import Berhasil.";
                    ...
                    Swal.fire(
                        ...
                        document.location.href = "<?= base_url('su/masterdata/tagihanbank'); ?>";
                    })
