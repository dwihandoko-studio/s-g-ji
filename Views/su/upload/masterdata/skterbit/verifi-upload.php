                ...
                <div class="table-responsive">
                    <table class="table table-bordered border-primary mb-0 modals-datatables-datanya" id="modals-datatables-datanya">
                        <thead>
                            <tr>
                                <th rowspan="2">#</th>
                                <th colspan="4">DATA TERBITK</th>
                                <th colspan="5">DATA USULAN</th>
                                <th rowspan="2">NO SKTP</th>
        ...
        fetch("./get_data_json?id=<?= $id ?>")
            ...
            .then(data => {
                ...
                for (let i = 0; i < data.data.length; i++) {
                    ...
                    const sktpCell = document.createElement("td");
                    const nosktpCell = document.createElement("td");
                    ...
                    sktpCell.textContent = data.data[i].no_sktp;
                    nosktpCell.textContent = data.data[i].no_urut;
                    ...
                    row.appendChild(sktpCell);
                    row.appendChild(nosktpCell);
            ...
            let sendToServer = function(lines, index) {
                if (index > lines.length - 1) {
                    ...
                    Swal.fire(
                        ...
                        document.location.href = "<?= base_url('situgu/su/us/tpg/skterbit'); ?>";
                    })
