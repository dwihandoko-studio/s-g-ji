        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">DATA POTONGAN INFAK</h4>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-6">
                                <h4 class="card-title">Data Potongan Infak</h4>
...
<script>
    function actionGenerate(event) {
        Swal.fire({
            title: 'Apakah anda yakin ingin mengenerate potongan untuk INFAK Tahun <?= $tw->tahun ?> - Bulan <?= $tw->bulan ?>?',
            text: "Generate Potongan Infak : Tahun <?= $tw->tahun ?> - Bulan <?= $tw->bulan ?> ",
