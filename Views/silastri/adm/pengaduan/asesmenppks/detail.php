<?php if (isset($data)) { ?>
    <div class="modal-body">
        ...
        <div class="row mt-2">
            ...
            <div class="col-lg-12">
                <label class="col-form-label">Media Pengaduan (FrontOffice):</label>
                <input type="text" class="form-control" value="<?= $data->media_pengaduan ?>" readonly />
            </div>
    ...
    <script>
        function actionTolak(e) {
            ...
            Swal.fire({
                title: 'Apakah anda yakin ingin menolak asesment pengaduan layanan ppks ini?',
                text: "Tolak asesment pengaduan layanan ppks : <?= $data->kategori ?> - dari : <?= str_replace('&#039;', "`", str_replace("'", "`", $data->nama)) ?> , dengan Kode Aduan: <?= $data->kode_aduan ?>",
                    ...
                    $.ajax({
                        ...
                        success: function(resul) {
                            ...
                            if (resul.status !== 200) {
                                ...
                                $('#content-tolakModalLabel').html('TOLAK ASESMENT PENGADUAN LAYANAN PPKS <?= $data->kategori ?> dari ' + nama + ', dengan Kode Aduan: ' + kode);
