<?php if (isset($data)) : ?>
    <form id="tindakLanjutPengaduanForm">
        <div class="modal-body">
            ...
            <div class="col-lg-12">
                <div class="mb-3">
                    <label class="form-label">Pilih Jumlah Lampiran Dokumen :</label>
                    <select class="form-control select2" id="_jumlah_lampiran" name="_jumlah_lampiran" style="width: 100%">
                        <option value=""> --- Pilih Jumlah Lampiran --- </option>
                        <option value="-"> Tidak ada lampiran </option>
                        <?php for ($i = 1; $i < 11; $i++) { ?>
                            <option value="<?= $i ?>"><?= $i ?></option>
                        <?php } ?>
                    </select>
                    <div class="help-block _jumlah_lampiran"></div>
                </div>
            </div>
        </div>
        </div>
