        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">DETAIL SELESAI PERMOHONAN LAYANAN</h4>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mt-2">
                            <div class="col-lg-12">
                                <button type="button" onclick="actionDownload(this)" class="btn btn-primary waves-effect waves-light">Download File Hasil Pengajuan Layanan</button>
                            </div>
                        </div>
                    </div>
                </div>
