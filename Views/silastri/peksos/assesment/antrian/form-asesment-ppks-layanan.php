        ...
        <div class="modal-body">
            ...
            <div class="row">
                        ...
                        <?php if (isset($kecamatans)) { ?>
                            <?php if (count($kecamatans) > 0) { ?>
                                <?php foreach ($kecamatans as $key => $value) { ?>
                                    <option value="<?= $value->id ?>" <?= $value->id == $data->kecamatan ? ' selected' : '' ?>><?= $value->kecamatan ?></option>
                                <?php } ?>
                            <?php } ?>
                        <?php } ?>
                    </select>
                        ...
                        <?php if (isset($kelurahans)) { ?>
                            <?php if (count($kelurahans) > 0) { ?>
                                <?php foreach ($kelurahans as $key => $value) { ?>
                                    <option value="<?= $value->id ?>" <?= $value->id == $data->kelurahan ? ' selected' : '' ?>><?= $value->kelurahan ?></option>
                                <?php } ?>
                            <?php } ?>
                        <?php } ?>
                    </select>
                ...
                <div class="col-lg-6">
                    ...
                    <textarea class="form-control" id="_alamat_ktp" name="_alamat_ktp"><?= $data->alamat ?></textarea>
                ...
                <div class="col-lg-6">
                    <label class="col-form-label">Alamat:</label>
                    <textarea class="form-control" id="_alamat_domisili" name="_alamat_domisili"><?= $data->alamat ?></textarea>
                ...
                <div class="col-lg-12">
                    ...
                    <p style="margin-bottom: 30px;">Silahkan lampirkan dokumen assesment (KTP, KK, Foto Rumah 4 Sisi, Asset).</p>
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mt-3">
