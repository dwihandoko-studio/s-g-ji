<?php if (isset($data)) { ?>
    ...
    <div class="modal-footer">
        ...
        <button type="button" onclick="actionTolak(this)" class="btn btn-danger waves-effect waves-light">Tolak Asesment</button>
        <button type="button" onclick="actionApprove(this)" class="btn btn-success waves-effect waves-light">Tindak Lanjuti Asesment</button>
    </div>
    <script>
        function actionTolak(e) {
            const nama = '<?= str_replace('&#039;', "`", str_replace("'", "`", $data->nama)) ?>';
            const kode = '<?= str_replace('&#039;', "`", str_replace("'", "`", $data->kode_permohonan)) ?>';
            Swal.fire({
                title: 'Apakah anda yakin ingin menolak asesment layanan ini?',
                text: "Tolak asesment layanan : <?= $data->layanan ?> - dari : <?= str_replace('&#039;', "`", str_replace("'", "`", $data->nama)) ?> , dengan Kode Aduan: <?= $data->kode_permohonan ?>",
                    ...
                    $.ajax({
                        ...
                        success: function(resul) {
                            ...
                            if (resul.status !== 200) {
                                ...
                                $('#content-tolakModalLabel').html('TOLAK ASESMENT LAYANAN <?= $data->layanan ?> dari ' + nama + ', dengan Kode Aduan: ' + kode);
        ...
        function actionApprove(e) {
            ...
            Swal.fire({
                ...
                text: "Assesment Layanan : <?= $data->layanan ?> - dari : <?= str_replace('&#039;', "`", str_replace("'", "`", $data->nama)) ?> , dengan Kode Aduan: <?= $data->kode_permohonan ?>",
                showCancelButton: true,
                icon: 'question',
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                    ...
                    $.ajax({
                        ...
                        success: function(resul) {
                            ...
                            if (resul.status !== 200) {
                                ...
                                $('#content-approveModalLabel').html('ASSESMENT LAYANAN <?= $data->layanan ?> dari ' + nama + ', dengan Kode Aduan: ' + kode);
