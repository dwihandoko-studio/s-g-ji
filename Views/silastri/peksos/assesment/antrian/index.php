        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">ASESMENT PENGADUAN / LAYANAN PPKS</h4>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-6">
                                <h4 class="card-title">Data Asesment Pengaduan / Layanan PPKS</h4>
                            </div>
                            <div class="col-6">
                                <div class="mb-3">
                                    <label for="_filter_kategori" class="col-form-label">Filter Layanan:</label>
...
<script>
    function actionDetail(id, kode, jenis) {
        $.ajax({
            url: "./detail",
            type: 'POST',
            data: {
            ...
            success: function(resul) {
                ...
                if (resul.status !== 200) {
                    ...
                    $('#content-detailModalLabel').html('DETAIL DATA ASSESMENT ' + jenis + ' (' + kode + ')');
