            ...
            <div class="collapse navbar-collapse" id="topnav-menu-content">
                <ul class="navbar-nav">
                    <?php if (isset($user)) { ?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?= ($uri->getSegment(2) == "ptk" && $uri->getSegment(3) == "infogtk") ? ' active-menu-href' : '' ?>" href="<?= ($uri->getSegment(2) == "ptk" && $uri->getSegment(3) == "infogtk") ? 'javascript:;' : base_url('situgu/ptk/infogtk') ?>">
