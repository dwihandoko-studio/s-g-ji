                    ...
                    <?php if (isset($user)) { ?>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="topnav-setting">
                                ...
                                <a href="<?= base_url('situgu/su/setting/grantedverikasi') ?>" class="dropdown-item <?= ($uri->getSegment(2) == "su" && $uri->getSegment(3) == "setting" && $uri->getSegment(4) == "grantedverikasi") ? ' active-menu-href' : '' ?>" key="t-setting-grantedverikasi">Acess Verifikasi</a>
