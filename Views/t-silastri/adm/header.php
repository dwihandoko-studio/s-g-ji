    ...
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="<?= ($uri->getSegment(2) == "adm" && $uri->getSegment(3) == "home") ? 'javascript:;' : base_url('silastri/adm/home') ?>" class="logo logo-dark">
                    <span class="logo-sm">
                ...
                <a href="<?= ($uri->getSegment(2) == "adm" && $uri->getSegment(3) == "home") ? 'javascript:;' : base_url('silastri/adm/home') ?>" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="<?= base_url() ?>/assets/images/lastri.svg" alt="" width="120">
                    </span>
                    <span class="logo-lg">
