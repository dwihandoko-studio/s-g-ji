    ...
    <div data-simplebar class="h-100">
        <div id="sidebar-menu">
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li <?= ($uri->getSegment(2) == "su" && $uri->getSegment(3) == "home") ? ' class="mm-active"' : '' ?>>
                    <a href="<?= ($uri->getSegment(2) == "su" && $uri->getSegment(3) == "home") ? 'javascript: void(0);' : base_url('silastri/su/home') ?>" class="waves-effect <?= ($uri->getSegment(2) == "su" && $uri->getSegment(3) == "home") ? ' mm-active' : '' ?>">
                        <i class="bx bx-home-circle"></i>
                        <span key="t-dashboards">Dashboard</span>
                    </a>
                </li>
                <li <?= ($uri->getSegment(2) == "su" && $uri->getSegment(3) == "masterdata") ? ' class="mm-active"' : '' ?>>
                    <a href="javascript: void(0);" class="has-arrow waves-effect <?= ($uri->getSegment(2) == "su" && $uri->getSegment(3) == "masterdata") ? ' mm-active' : '' ?>">
                ...
                <li <?= ($uri->getSegment(2) == "su" && $uri->getSegment(3) == "layanan") ? ' class="mm-active"' : '' ?>>
                    ...
                    <ul class="sub-menu  <?= ($uri->getSegment(2) == "su" && $uri->getSegment(3) == "layanan") ? ' mm-collapse mm-active' : '' ?>" aria-expanded="false">
                        <li><a <?= ($uri->getSegment(2) == "su" && $uri->getSegment(3) == "layanan" && $uri->getSegment(4) == "antrian") ? ' class="mm-active"' : '' ?> href="<?= base_url('silastri/su/layanan/antrian') ?>" key="t-layanan-antrian">Antrian</a></li>
                        <li><a <?= ($uri->getSegment(2) == "su" && $uri->getSegment(3) == "layanan" && $uri->getSegment(4) == "proses") ? ' class="mm-active"' : '' ?> href="<?= base_url('silastri/su/layanan/proses') ?>" key="t-layanan-proses">Diproses</a></li>
                        <li><a <?= ($uri->getSegment(2) == "su" && $uri->getSegment(3) == "layanan" && $uri->getSegment(4) == "selesai") ? ' class="mm-active"' : '' ?> href="<?= base_url('silastri/su/layanan/selesai') ?>" key="t-layanan-selesai">Selesai</a></li>
                ...
                <!-- <li <?= ($uri->getSegment(2) == "su" && $uri->getSegment(3) == "layanan") ? ' class="mm-active"' : '' ?>>
                    ...
                    <ul class="sub-menu  <?= ($uri->getSegment(2) == "su" && $uri->getSegment(3) == "home") ? ' mm-collapse mm-active' : '' ?>" aria-expanded="false">
                        <?php
                        // $menus = getLayananSilastri();
                        $menus = false;
                        ?>
                        <?php if ($menus) { ?>
                            <?php if (count($menus) > 0) { ?>
                                <?php foreach ($menus as $key => $v) { ?>
                                    <li><a <?= ($uri->getSegment(2) == "su" && $uri->getSegment(3) == "layanan" && $uri->getSegment(4) == $v['layanan_menu']) ? ' class="mm-active"' : '' ?> href="<?= base_url('silastri/su/layanan/' . $v['layanan_menu']) ?>" key="t-layanan-<?= $v['layanan_menu'] ?>"><?= $v['layanan_singkatan'] ?></a></li>
                                <?php } ?>
                            <?php } ?>
                        <?php } ?>
                    </ul>
