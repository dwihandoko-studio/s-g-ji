        ...
        <div id="sidebar-menu">
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li <?= ($uri->getSegment(2) == "peng" && $uri->getSegment(3) == "home") ? ' class="mm-active"' : '' ?>>
                    <a href="<?= ($uri->getSegment(2) == "peng" && $uri->getSegment(3) == "home") ? 'javascript: void(0);' : base_url('silastri/peng/home') ?>" class="waves-effect <?= ($uri->getSegment(2) == "peng" && $uri->getSegment(3) == "home") ? ' mm-active' : '' ?>">
