    ...
    <div data-simplebar class="h-100">
        <div id="sidebar-menu">
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li <?= ($uri->getSegment(2) == "kepala" && $uri->getSegment(3) == "home") ? ' class="mm-active"' : '' ?>>
                    <a href="<?= ($uri->getSegment(2) == "kepala" && $uri->getSegment(3) == "home") ? 'javascript: void(0);' : base_url('silastri/kepala/home') ?>" class="waves-effect <?= ($uri->getSegment(2) == "kepala" && $uri->getSegment(3) == "home") ? ' mm-active' : '' ?>">
                        <i class="bx bx-home-circle"></i>
                        <span key="t-dashboards">Dashboard</span>
                    </a>
                </li>
                <li <?= ($uri->getSegment(2) == "kepala" && $uri->getSegment(3) == "layanan") ? ' class="mm-active"' : '' ?>>
                    <a href="javascript: void(0);" class="has-arrow waves-effect <?= ($uri->getSegment(2) == "kepala" && $uri->getSegment(3) == "layanan") ? ' mm-active' : '' ?>">
                        <i class="bx bx-package"></i>
                        <span key="t-layanans">Layanan</span>
                    </a>
                    <ul class="sub-menu  <?= ($uri->getSegment(2) == "kepala" && $uri->getSegment(3) == "layanan") ? ' mm-collapse mm-active' : '' ?>" aria-expanded="false">
                        <li><a <?= ($uri->getSegment(2) == "kepala" && $uri->getSegment(3) == "layanan" && $uri->getSegment(4) == "antrian") ? ' class="mm-active"' : '' ?> href="<?= base_url('silastri/kepala/layanan/antrian') ?>" key="t-layanan-antrian">Antrian</a></li>
                        <li><a <?= ($uri->getSegment(2) == "kepala" && $uri->getSegment(3) == "layanan" && $uri->getSegment(4) == "approved") ? ' class="mm-active"' : '' ?> href="<?= base_url('silastri/kepala/layanan/approved') ?>" key="t-layanan-approved">Approved TTE</a></li>
                        <li><a <?= ($uri->getSegment(2) == "kepala" && $uri->getSegment(3) == "layanan" && $uri->getSegment(4) == "ditolak") ? ' class="mm-active"' : '' ?> href="<?= base_url('silastri/kepala/layanan/ditolak') ?>" key="t-layanan-ditolak">Ditolak</a></li>
                    </ul>
                </li>
                <!-- 
                <li>
