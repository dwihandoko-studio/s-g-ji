    ...
    <div data-simplebar class="h-100">
        <div id="sidebar-menu">
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li <?= ($uri->getSegment(2) == "operator" && $uri->getSegment(3) == "home") ? ' class="mm-active"' : '' ?>>
                    <a href="<?= ($uri->getSegment(2) == "operator" && $uri->getSegment(3) == "home") ? 'javascript: void(0);' : base_url('silastri/operator/home') ?>" class="waves-effect <?= ($uri->getSegment(2) == "operator" && $uri->getSegment(3) == "home") ? ' mm-active' : '' ?>">
                        <i class="bx bx-home-circle"></i>
                        <span key="t-dashboards">Dashboard</span>
                    </a>
                </li>
                <li <?= ($uri->getSegment(2) == "operator" && $uri->getSegment(3) == "layanan") ? ' class="mm-active"' : '' ?>>
                    <a href="javascript: void(0);" class="has-arrow waves-effect <?= ($uri->getSegment(2) == "operator" && $uri->getSegment(3) == "layanan") ? ' mm-active' : '' ?>">
                        <i class="bx bx-package"></i>
                        <span key="t-layanans">Layanan</span>
                    </a>
                    <ul class="sub-menu  <?= ($uri->getSegment(2) == "operator" && $uri->getSegment(3) == "layanan") ? ' mm-collapse mm-active' : '' ?>" aria-expanded="false">
                        <li><a <?= ($uri->getSegment(2) == "operator" && $uri->getSegment(3) == "layanan" && $uri->getSegment(4) == "antrian") ? ' class="mm-active"' : '' ?> href="<?= base_url('silastri/operator/layanan/antrian') ?>" key="t-layanan-antrian">Antrian</a></li>
                        <li><a <?= ($uri->getSegment(2) == "operator" && $uri->getSegment(3) == "layanan" && $uri->getSegment(4) == "proses") ? ' class="mm-active"' : '' ?> href="<?= base_url('silastri/operator/layanan/proses') ?>" key="t-layanan-proses">Diproses</a></li>
                        <li><a <?= ($uri->getSegment(2) == "operator" && $uri->getSegment(3) == "layanan" && $uri->getSegment(4) == "selesai") ? ' class="mm-active"' : '' ?> href="<?= base_url('silastri/operator/layanan/selesai') ?>" key="t-layanan-selesai">Selesai</a></li>
                        <li><a <?= ($uri->getSegment(2) == "operator" && $uri->getSegment(3) == "layanan" && $uri->getSegment(4) == "ditolak") ? ' class="mm-active"' : '' ?> href="<?= base_url('silastri/operator/layanan/ditolak') ?>" key="t-layanan-ditolak">Ditolak</a></li>
                    </ul>
                </li>
