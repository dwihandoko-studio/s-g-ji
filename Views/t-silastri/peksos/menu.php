    ...
    <div data-simplebar class="h-100">
        <div id="sidebar-menu">
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li <?= ($uri->getSegment(2) == "peksos" && $uri->getSegment(3) == "home") ? ' class="mm-active"' : '' ?>>
                    <a href="<?= ($uri->getSegment(2) == "peksos" && $uri->getSegment(3) == "home") ? 'javascript: void(0);' : base_url('silastri/peksos/home') ?>" class="waves-effect <?= ($uri->getSegment(2) == "peksos" && $uri->getSegment(3) == "home") ? ' mm-active' : '' ?>">
                ...
                <!-- <li <?= ($uri->getSegment(2) == "peksos" && $uri->getSegment(3) == "layanan") ? ' class="mm-active"' : '' ?>>
                    ...
                    <ul class="sub-menu  <?= ($uri->getSegment(2) == "peksos" && $uri->getSegment(3) == "layanan") ? ' mm-collapse mm-active' : '' ?>" aria-expanded="false">
                        <li><a <?= ($uri->getSegment(2) == "peksos" && $uri->getSegment(3) == "layanan" && $uri->getSegment(4) == "antrian") ? ' class="mm-active"' : '' ?> href="<?= base_url('silastri/peksos/layanan/antrian') ?>" key="t-layanan-antrian">Antrian</a></li>
                        <li><a <?= ($uri->getSegment(2) == "peksos" && $uri->getSegment(3) == "layanan" && $uri->getSegment(4) == "proses") ? ' class="mm-active"' : '' ?> href="<?= base_url('silastri/peksos/layanan/proses') ?>" key="t-layanan-proses">Diproses</a></li>
