...
<head>
    <meta charset="utf-8" />
    <title><?= isset($title) ? $title : "Peksos" ?></title>
...
<body data-sidebar="dark" data-layout-mode="light" class="loading-logout">
    <div id="layout-wrapper">
        <?= $this->include('t-silastri/peksos/header'); ?>
        <?= $this->include('t-silastri/peksos/menu'); ?>
    ...
    <script>
        ...
        $(document).ready(function() {
            $.ajax({
                url: "<?= base_url('silastri/peksos/notification/getNotifShowed') ?>",
                type: 'GET',
                dataType: 'JSON',
                // beforeSend: function() {
