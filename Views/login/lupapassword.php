                            ...
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="my-auto content-terkirim-reset-password">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted">Reset password akun layanan anda.</p>
                                    </div>

                                    <div class="mt-4">
                                        <div class="alert alert-success text-center mb-4" role="alert">
                                            Masukkan email terdaftar anda, kami akan mengirimkan instruksi untuk mereset password anda!
                                        </div>
                                        <form action="./kirimlupapassword">

                                            <div class="mb-3">
                                                <label for="_email" class="form-label">Email</label>
                                                <input type="email" class="form-control" id="_email" name="_email" placeholder="Masukkan email">
                                            </div>
