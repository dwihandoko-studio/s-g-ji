                                ...
                                <div class="card-body">
                                    <div class="">
                                        <div class="alert alert-success" role="alert">
                                            ...
                                            <p>Silahkan cek pada menu Usulan TPG Anda.</p>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="">
                                        <div class="alert alert-success" role="alert">
                                            <h4 class="alert-heading">Anda Sudah Dalam Pengajuan Usulan Tunjangan!</h4>
                                            <p>Silahkan cek pada menu Usulan TPG.</p>
                                            <p class="mb-0">Status pengajuan usulan tunjangan anda saat ini berada dalam tahap : <b>
                                                    <?php
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="">
                                    <div class="alert alert-warning" role="alert">
                                        <h4 class="alert-heading">Anda Sebelumnya Sudah Mengajukan Usulan Tunjangan</h4>
                                        <p>Namun pengajuan anda telah ditolak / dibatalkan dalam proses verifikasi Koordinator Pengawas Kabupaten, dengan Keterangan: </p>
                                        <p class="mb-0"><b>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="">
                                    <div class="alert alert-info" role="alert">
                                        <h4 class="alert-heading">Anda Sebelumnya Sudah Mengajukan Usulan Tunjangan</h4>
                                        <p>Saat ini proses usulan anda menunggu proses Generate SPTJM dari Koordinator Pengawas Kabupaten. </p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="">
                                            <div class="alert alert-success" role="alert">
                                                ...
                                                <p class="mb-0">Status pengajuan usulan tunjangan anda saat ini berada dalam tahap : <b>
                                                        ...
                                                        switch ($data_antrian_tpg_transfer->status_usulan) {
                                                            case 0:
                                                                echo '<span class="badge rounded-pill bg-dark">Antrian SPTJM Koordinator Pengawas Kabupaten</span>';
                                                                break;
                                                            case 1:
                                                                echo '<span class="badge rounded-pill bg-dark">Antrian Verifikasi Admin</span>';
                                                                break;
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="">
                                        <div class="alert alert-info" role="alert">
                                            <h4 class="alert-heading">Anda Sebelumnya Sudah Mengajukan Usulan Tunjangan</h4>
                                            <p>Saat ini proses usulan anda menunggu proses Upload SPTJM dari Koordinator Pengawas Kabupaten. </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="">
                                    <div class="alert alert-info" role="alert">
                                        <h4 class="alert-heading">Anda Sebelumnya Sudah Mengajukan Usulan Tunjangan</h4>
                                        <p>Saat ini proses usulan anda menunggu verifikasi oleh Koordinator Pengawas Kabupaten untuk proses generate SPTJM. </p>
                                    </div>
                                </div>
                            </div>
                        </div>
