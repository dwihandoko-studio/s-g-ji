        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">SETTING UPLOAD SPJ</h4>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-6">
                                <h4 class="card-title">Data Setting Upload SPJ</h4>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <h4 class="mb-2">SPJ UTPG</h4>
                            <table class="table table-bordered border-success mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td><?= $spj->max_download_spj ?></td>
                                        <td><?= $spj->max_upload_spj ?></td>
                                    </tr>
                                </tbody>
                            </table>
                            <hr />
                            <h4 class="mb-2 mt-2">SPJ TAMSIL</h4>
                            <table class="table table-bordered border-success mb-0">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td><?= $spjTamsil->max_download_spj ?></td>
                                        <td><?= $spjTamsil->max_upload_spj ?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
