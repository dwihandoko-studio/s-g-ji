        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">DATA USULAN TAMSIL LOLOS BERKAS</h4>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-6">
                                <h4 class="card-title">Data Usulan Tamsil Lolos Berkas</h4>
...
<script>
    function actionDownload(event) {
        ...
        console.log(tw);
        if (tw === undefined || tw === "") {
            const linkSource = "<?= base_url('situgu/adm/us/tamsil/lolosberkas/download') ?>?tw=<?= $tw->id ?>";
            ...
            const linkSource = "<?= base_url('situgu/adm/us/tamsil/lolosberkas/download') ?>?tw=" + tw;
            const downloadLink = document.createElement("a");
            downloadLink.href = linkSource;
            downloadLink.onclick = function() {
                window.open(this.href);
