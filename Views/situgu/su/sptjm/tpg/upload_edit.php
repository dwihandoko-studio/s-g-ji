<?php if (isset($data)) { ?>
    <form id="formEditModalData" action="./uploadEditSave" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mt-3">
                                <label for="_file" class="form-label">Upload SPTJM Verifikasi TPG Tahun <?= $tahun ?> - TW <?= $tw ?>: </label>
