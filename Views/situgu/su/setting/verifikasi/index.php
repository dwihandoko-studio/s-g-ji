        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">SETTING JADWAL VERIFIKASI</h4>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-6">
                                <h4 class="card-title">Data Setting Jadwal Verifikasi</h4>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <h4 class="mb-2">Verifikasi UTPG</h4>
                            <table class="table table-bordered border-success mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td><?= $verifikasi->max_download_verifikasi ?></td>
                                        <td><?= $verifikasi->max_upload_verifikasi ?></td>
                                    </tr>
                                </tbody>
                            </table>
                            <hr />
                            <h4 class="mb-2 mt-2">Verifikasi TAMSIL</h4>
                            <table class="table table-bordered border-info mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td><?= $verifikasiTamsil->max_download_verifikasi ?></td>
                                        <td><?= $verifikasiTamsil->max_upload_verifikasi ?></td>
                                    </tr>
                                </tbody>
                            </table>
                            <hr />
                            ...
                            <table class="table table-bordered border-warning mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td><?= $verifikasiPghm->max_download_verifikasi ?></td>
                                        <td><?= $verifikasiPghm->max_upload_verifikasi ?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
...
<script>
        ...
        $.ajax({
            ...
            success: function(resul) {
                ...
                if (resul.status !== 200) {
                    ...
                    $('#content-detailModalLabel').html('SETTING VERIFIKASI TPG');
        ...
        $.ajax({
            ...
            success: function(resul) {
                ...
                if (resul.status !== 200) {
                    ...
                    $('#content-detailModalLabel').html('SETTING VERIFIKASI TAMSIL');
                    $('.contentBodyModal').html(resul.data);
                    $('.content-detailModal').modal({
                        backdrop: 'static',
                        keyboard: false,
        ...
        $.ajax({
            ...
            success: function(resul) {
                ...
                if (resul.status !== 200) {
                    ...
                    $('#content-detailModalLabel').html('SETTING VERIFIKASI PGHM');
                    $('.contentBodyModal').html(resul.data);
                    $('.content-detailModal').modal({
                        backdrop: 'static',
                        keyboard: false,
    ...
    $(document).ready(function() {
        ...
        //     "order": [],
        //     "ajax": {
        //         "url": "<?= base_url('situgu/su/setting/role/getAll') ?>",
        //         "type": "POST",
