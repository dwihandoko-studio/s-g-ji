        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-lg-10">
                    ...
                    <input type="text" class="form-control judul" value="<?= $data->judul ?>" id="_judul" name="_judul" placeholder="Judul Informasi..." onfocusin="inputFocus(this);">
                    <div class="help-block _judul"></div>
                </div>
                <div class="col-lg-12">
                    <label for="_isi" class="col-form-label">Isi Informasi:</label>
                ...
                <div class="col-lg-12 mt-4">
                    <div class="row mt-4">
                        <div class="col-lg-6">
                            <div class="mt-3">
                                <label for="_file" class="form-label">Gambar Pengumuman: </label>
                        ...
                        <div class="col-lg-6">
                            <div class="mt-3">
                                <label for="_file_lampiran" class="form-label">Lampiran Pengumuman: </label>
                            ...
                            <div class="form-group">
                                <div class="preview-image-upload">
                                    <?php if ($data->lampiran !== null) { ?>
                                        <a target="_blank" href="<?= base_url() . '/uploads/pengumuman/' . $data->lampiran ?>" class="badge badge-pill badge-soft-success">Lampiran pengumuman</a>
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
