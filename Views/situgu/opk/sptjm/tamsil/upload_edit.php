<?php if (isset($data)) { ?>
    <form id="formEditUploadModalData" action="./uploadEditSave" method="post" enctype="multipart/form-data">
        <input type="hidden" id="_tahun" name="_tahun" value="<?= $tahun ?>" />
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mt-3">
                                <label for="_file" class="form-label">EDIT SPTJM Verifikasi Tamsil Tahun <?= $tahun ?> - TW <?= $tw ?>: </label>
    ...
    <script>
        ...
        $("#formEditUploadModalData").on("submit", function(e) {
            e.preventDefault();
